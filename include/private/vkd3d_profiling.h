...
unsigned int vkd3d_profiling_register_region(const char *name, spinlock_t *lock, spinlock_t *latch) DECLSPEC_HIDDEN;
...
#define VKD3D_REGION_DECL(name) \
    static spinlock_t _vkd3d_region_latch_##name; \
